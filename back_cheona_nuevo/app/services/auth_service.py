...
def login_user(data: LoginRequest):
    query = "SELECT idcliente, nombre, password, email, rol FROM cliente WHERE email = %s"
    ...
    idcliente, nombre, hashed_password, email, rol = user
    if not rol:
        rol = 'client'
    ...
    access_token = create_access_token({"id_cliente": idcliente})
